...
def linearUp (startingDate, endingDate, minValue=MIN, maxValue=MAX):
    """
    ...
    DowJones = yf.download('DIA', startingDate, endingDate)
...
def linearDown (startingDate, endingDate, minValue=MIN, maxValue=MAX):
    """
...
def sinusoidal(startingDate, endingDate, minValue=MIN, maxValue=MAX, period=PERIOD):
    """
...
def triangle(startingDate, endingDate, minValue=MIN, maxValue=MAX, period=PERIOD):
    """
